...
<section class="home-valve-section">
  <div class="home-valve-container">
    ...
    <section class="home-butterfly-valve-section">
      <div class="home-globe-valve-content">
        <a href="#"><img src="./assets/images/valve5.png" alt="Butterfly valve"
...
`,ve=()=>{let e=document.querySelector(".typeJsText");console.log("typeJsText",e);let s=["FULLY.","SUCESS.","AUTOMATED.","VALVE PURCHASING.","PROCCESSES."],t=0,a=0,i=!1;function n(){e?i?a>=0?(e.innerHTML=e.innerHTML.substring(0,a),a--,setTimeout(n,100)):(i=!1,t=(t+1)%s.length,setTimeout(n,500)):a<s[t].length?(e.innerHTML+=s[t].charAt(a),a++,setTimeout(n,100)):setTimeout(()=>{i=!0,n()},1e3):console.log("Element .typeJsText not found")}n()},pe=()=>{let e=document.querySelector(".SecondtypeJsText");console.log("SecondtypeJsText",e);let s=["602","6D","600","594","609","602","623"],t=0,a=0,i=!1;function n(){e?i?a>=0?(e.innerHTML=e.innerHTML.substring(0,a),a--,setTimeout(n,100)):(i=!1,t=(t+1)%s.length,setTimeout(n,90)):a<s[t].length?(e.innerHTML+=s[t].charAt(a),a++,setTimeout(n,100)):setTimeout(()=>{i=!0,n()},6e3):console.log("Element .SecondtypeJsText not found")}n()},he=()=>{let e=document.querySelector(".DescriptionpeJsText"),s=[`Forged steel valves with threaded, bolted and welded ends, including
...
<main class="header-container container-parallax-globe-valves">
  ...
  <div class="header-content-wrapper">
    <header class="header-header">
      ...
      <nav class="header-navigation">
        <a href="/gate-valves" class="link">GATE VALVES</a>
        <a href="/glove-valves" class="link">glove VALVES</a>
        <a href="/globe-valves" class="link">GLOBE VALVES</a>
        <a href="/trunnion-valves" class="link">TRUNNION VALVES</a>
        <a href="/floating-valves" class="link">FLOATING VALVES</a>
        <div class="dropdown">
...
`,m=document.getElementById("app"),be=()=>{p("/",()=>{m.innerHTML=ie,ve(),me(),pe(),he(),h(),window.addEventListener("scroll",u);const e=document.getElementById("fire-video");e&&(e.playbackRate=.45),ue()}),p("/about-us",()=>{m.innerHTML=ne,h(),window.addEventListener("scroll",u)}),p("/steps",()=>{m.innerHTML=oe,S(),h(),window.addEventListener("scroll",u)}),p("/gate-valves",()=>{m.innerHTML=le,h(),window.addEventListener("scroll",u)}),p("/globe-valves",()=>{m.innerHTML=fe,h(),window.addEventListener("scroll",u)}),p("/check-valves",()=>{m.innerHTML=re,h(),window.addEventListener("scroll",u)}),p("/certifications",()=>{m.innerHTML=ce,S(),h(),window.addEventListener("scroll",u)}),p("/trunnion-valves",()=>{m.innerHTML=de,S(),h(),window.addEventListener("scroll",u)}),p("/floating-valves",()=>{m.innerHTML=ge,S(),h(),window.addEventListener("scroll",u)}),p()};document.addEventListener("DOMContentLoaded",()=>{be()});
